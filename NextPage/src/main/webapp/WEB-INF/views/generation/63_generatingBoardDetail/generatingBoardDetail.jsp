  					...
  					<div class="site-section">
						<div class="container">
							<table class="table table-bordered table-hover">
								...
								<tr>
									<td id="cntnt" colspan="4" style="height: 400px;">${genPost.postCntnt}</td>
								</tr>
								<tr>
									<td rowspan="30">첨부파일</td>
								</tr>
							...
							<c:if test="${sessionScope.authMem eq genPost.memId eq sessionScope.authVal eq 'SCH'}">
							...
							<!-- 대기,접수,완료 -->
							<c:if test="${sessionScope.authVal eq 'SCH'}">
								<c:if test="${genPost.postPrgrsPrsntCndtn eq '대기'}">
									<div class="row-right" style="margin-left: 90%;">
										<button class="btn btn-sm btn-primary" style="padding: 0.5rem 1rem;font-size: 1.0rem;" onclick="">대기</button>
									</div>
								</c:if>
							</c:if>
						<!--댓글 -->
