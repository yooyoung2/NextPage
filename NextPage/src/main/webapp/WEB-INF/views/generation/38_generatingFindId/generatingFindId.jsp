		...
		<h2 id="h2Tag" class="row align-items-end justify-content-center text-center">아이디찾기</h2>
				...
				<form action="id" method="post">
					<div class="col-md-12 form-group">
						...
						<input type="text" id="username" name="schNm" class="form-control form-control-lg" />
					</div>
					<div class="col-md-12 form-group">
						<label for="pword">이메일</label>
						<input type="email" id="email" name="schEmail" class="form-control form-control-lg" />
					</div>
