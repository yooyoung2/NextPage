...
<br>
	...
	<div class="container" style="margin-top: -7%;">
		...
		<br>
		<div class="justify-content-center" style="padding: 0px 120px;">
...
<script type="text/javascript">
	...
	let innerDiv = $("<div class='feature-1 border text-center' style='height: 265px; width:175px; background-color:white;'>");
	let inner2Div = $("<div class='feature-1-content' style='padding-top:1%;'> ")
	let aTag = $("<a>").attr("href", "${pageContext.request.contextPath}/generation/"+schIdqqq+"/board/detail?brdNum="+brdNum+"&what="+genPost.postNum);
// 	let img = $("<img>").attr("src", "${pageContext.request.contextPath}/resources/templates/template01/template01Index/images/person_3.jpg")
//     .attr("class","img-fluid");
	
	let img = $("<video>").attr("src","data:video/mp4;base64,"+genPost.realName)
    .attr("class","img-fluid")
    .attr("style","width:300px; height:136px;");
