						...
						<div class="container">
							<table class="table table-bordered">
								...
								<tr>
									...
									{
										%>
<%--  										<img style="width:600px; height:400px; margin-bottom:20px;" src="data:image/*;base64,<%=ImageList.get(i).getSaveName()%>"/>  --%>
											<video src="data:video/mp4;base64,<%=ImageList.get(i).getSaveName()%>" style="width:100%;" controls></video>
										<%
									}
