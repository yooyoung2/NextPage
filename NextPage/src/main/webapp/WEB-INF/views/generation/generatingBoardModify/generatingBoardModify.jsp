							...
							<%
								...
								for(int i=0;i<genList.size();i++)
								  {%>
									<tr>
									<td colspan="30">
									<a href="<%=request.getContextPath() %>/board/download?what=<%=genList.get(i).getSaveName() %>" style="color:blue;"><%=genList.get(i).getFileName() %></a><input type="file" id="boFiles" name="boFiles">
 							...
 							<tr id="notis">
								...
								<td colspan="3">
									...
									<input type="radio" name="postNotisWhether" value="NO">미사용
								</td>
							</tr>
							<tr id="scrt">
								<td>비밀글 여부</td>
								<td colspan="3">
									...
									<input type="radio" name="postScrtWhether" value="NO">미사용
								</td>
							</tr> 
						</table>
						<input name="prgrsCndtn" type="hidden" value="대기" id="prgrs">
