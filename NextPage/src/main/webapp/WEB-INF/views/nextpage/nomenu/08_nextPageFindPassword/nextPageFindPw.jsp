            ...
            <div id="formBox" class="col-lg-5 col-12">
                    ...
                    <form action="findPw.do" method="post">
                        <div class="form-group position-relative has-icon-left mb-4">
                            <label class="form-label" for="inputSchoolName">학교 아이디</label>
                  		    <input class="form-control form-control-xl" type="text" placeholder="학교아이디를 입력해주세요" name="schId" />
                        ...
                        <div class="col-4">
               	 	  		<input id="findBtn"  class="btn btn-primary btn-block btn-lg shadow-lg mt-5"
               	 	  				style="background-color: #6fbee3;; border: #6fbee3;;"type="submit"  value="전송" />
                 	    </div>
