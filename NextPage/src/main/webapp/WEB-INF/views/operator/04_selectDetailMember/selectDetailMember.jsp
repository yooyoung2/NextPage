...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                ...
                <section id="basic-horizontal-layouts ">
                    <div class="row match-height content">
                            <div class="card">
                                ...
                                <div class="card-content ">
                                    <div class="card-body ">
										<form class="form form-horizontal " id = "frm" action = "<%=request.getContextPath() %>/operator/update/detail/member" method = "post">
											<div class="form-body">
												<div class="row">
													<div class="col-md-4">
														<label>학교아이디</label>
                                                    ...
                                                    <label class="input-group-text"
                                                        for="inputGroupSelect01">운영상태 </label>
										...
										<div class="col-sm-12 d-flex justify-content-end">
                                                        <input type="button" id="btn"
                                                            class="btn btn-primary me-1 mb-1" value="수정">
