...
<!--     <meta content="" name="description"> -->
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/templates/nextpage/css/app.css">
    ...
    <!-- Favicon -->
    <link href="<%=request.getContextPath() %>/resources/templates/nextpage/img/favicon.ico" rel="icon">
    ...
    <link href="<%=request.getContextPath() %>/resources/templates/nextpage/css/bootstrap.min.css" rel="stylesheet">
