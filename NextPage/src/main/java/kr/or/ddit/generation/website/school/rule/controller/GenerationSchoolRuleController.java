package kr.or.ddit.generation.website.school.rule.controller;
...
@Slf4j
@Controller
public class GenerationSchoolRuleController {
	...
	@RequestMapping( value = "generation/{id}/generatingSchoolRule", method = RequestMethod.GET )
	public String generationSchoolRule(
		...
		// 여기부터
				...
				if( data != null && !data.isEmpty() ) {
					...
					viewName = "generation/template01/70_schoolRules/schoolRules";
				}else {
