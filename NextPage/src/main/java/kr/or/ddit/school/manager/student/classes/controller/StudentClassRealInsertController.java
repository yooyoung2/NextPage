...
@Slf4j
@Controller
@RequestMapping("school/manager/studentClassRealInsert")
public class StudentClassRealInsertController{
	...
	public String doPost(
		...
		ArrayList<ClassMemVO> list = (ArrayList) session.getAttribute("poi_list");
		...
		ClassMemVO data = new ClassMemVO();
		...
		for(int i = 0 ; i < list.size() ; i ++) {
			...
			case OK:
				...
				logicalViewName = "redirect:/school/manager/studentClass/insert";
				break;
