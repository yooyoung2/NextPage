...
@Controller
public class TeacherClassInsertAllController {
	List<Join_Year_SCH_VO> list;
	BufferedReader br;
	Function ft;
	@RequestMapping("school/manager/teacherClass/poi")
	public String schoolSymbol(@ModelAttribute("fileName") String fileName,
			...
			list = new ArrayList<Join_Year_SCH_VO>();
			ft = new Function();
