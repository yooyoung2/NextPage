...
import kr.or.ddit.school.manager.teacher.Insert.dao.TeacherInsertDAO;
...
public class TeacherInsertServiceImpl implements TeacherInsertService {
	@Inject
	private TeacherInsertDAO dao;
