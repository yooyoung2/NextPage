...
@Controller
public class StudentClassInsertAllController {
	List<ClassMemVO> list;
	BufferedReader br;
	Function ft;
	@RequestMapping("school/manager/studentClass/poi")
