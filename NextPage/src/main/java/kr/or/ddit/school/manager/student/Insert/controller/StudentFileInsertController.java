...
@Controller
@RequestMapping("school/manager/student/fileInsert")
public class StudentFileInsertController {
	...
	public String boardInsert(
		...
		if(!errors.hasErrors()) {
			...
			if(ServiceResult.OK.equals(result)) {
				viewName = "redirect:/schoolManager/104_studentInsert/InsertFile.jsp";
			}else {
				String message = "등록 실패";
				model.addAttribute("message", message);
				viewName = "schoolManager/104_studentInsert/studentInsert";
			}
		}else {
			viewName = "schoolManager/104_studentInsert/studentInsert";
		}
