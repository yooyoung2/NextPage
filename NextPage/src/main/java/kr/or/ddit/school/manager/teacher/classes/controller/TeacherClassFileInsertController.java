...
@Controller
@RequestMapping("school/manager/teacherClass/fileInsert")
public class TeacherClassFileInsertController {
	...
	public String boardForm() {
		...
		return "schoolManager/108_teacherClassInsert/InsertFile";
	}
	...
	public String boardInsert(
		...
		if(!errors.hasErrors()) {
			...
			if(ServiceResult.OK.equals(result)) {
				viewName = "redirect:/schoolManager/108_teacherClassInsert/InsertFile.jsp";
			}else {
				String message = "등록 실패";
				model.addAttribute("message", message);
				viewName = "schoolManager/108_teacherClassInsert/teacherClassInsert";
			}
		}else {
			viewName = "schoolManager/108_teacherClassInsert/teacherClassInsert";
		}
